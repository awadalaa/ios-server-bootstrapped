...
UserModel.remove({}, function(err) {
    var user = new UserModel({ username: "alaaawad", password: "passwordispassword" });
...
ClientModel.remove({}, function(err) {
    var client = new ClientModel({ name: "my iOS service client", clientId: "mobile_ios_client", clientSecret:"secretsaucebaby" });
