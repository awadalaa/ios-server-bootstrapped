...
- (instancetype) initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.created =  [aDecoder decodeIntegerForKey:NSStringFromSelector(@selector(created))];
...
- (void) encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeInteger:self.created forKey:NSStringFromSelector(@selector(created))];
