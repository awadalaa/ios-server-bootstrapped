//
//  SQImageLibraryViewController.m
//  login
//
...
@interface SQImageLibraryViewController () <SQCropImageViewControllerDelegate>
...
@implementation SQImageLibraryViewController
...
- (void) collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SQCropImageViewController *cropVC = [[SQCropImageViewController alloc] initWithImage:imageToCrop];
    cropVC.delegate = self;
    [self.navigationController pushViewController:cropVC animated:YES];
}

#pragma mark - SQCropImageViewControllerDelegate
