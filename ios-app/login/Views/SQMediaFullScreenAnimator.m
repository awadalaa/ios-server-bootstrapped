...
@implementation SQMediaFullScreenAnimator
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (self.presenting) {
        SQMediaFullScreenViewController *fullScreenVC = (SQMediaFullScreenViewController *)toViewController;
        ...
        SQMediaFullScreenViewController *fullScreenVC = (SQMediaFullScreenViewController *)fromViewController;
